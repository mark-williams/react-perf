...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lottery = __webpack_require__(168);
	
	var _lottery2 = _interopRequireDefault(_lottery);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	_reactDom2.default.render(_react2.default.createElement(_lottery2.default, null), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Chosen = __webpack_require__(169);
	
	var _Chosen2 = _interopRequireDefault(_Chosen);
	
	var _NumbersContainer = __webpack_require__(170);
	
	var _NumbersContainer2 = _interopRequireDefault(_NumbersContainer);
	
	var _lotteryStore = __webpack_require__(175);
	
	var _lotteryStore2 = _interopRequireDefault(_lotteryStore);
	
	var _lotteryActions = __webpack_require__(191);
	...
	var Lottery = function (_React$Component) {
	    ...
	    function Lottery() {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Lottery).call(this));
	
	        _lotteryStore2.default.dispatch((0, _lotteryActions.initPool)(POOLSIZE));
	    ...
	    _createClass(Lottery, [{
	        ...
	        value: function onStoreUpdated() {
	            ...
	            this.setState(_lotteryStore2.default.getState);
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'row' },
	                    _react2.default.createElement(_Chosen2.default, { selection: this.state.chosen })
	                ),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'row' },
	                    _react2.default.createElement(_NumbersContainer2.default, { numbers: this.state.numbers, chosen: this.state.chosen })
	                )
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Chosen = function Chosen(props) {
	    return _react2.default.createElement(
	        "h4",
	        null,
	        props.selection.map(function (n) {
	            return _react2.default.createElement(
	                "span",
	                { key: n, className: "chosen" },
	                n
	            );
	        })
	    );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NumbersContainer = function (_React$Component) {
	    _inherits(NumbersContainer, _React$Component);
	
	    function NumbersContainer(props) {
	        _classCallCheck(this, NumbersContainer);
	
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(NumbersContainer).call(this));
	    }
	
	    _createClass(NumbersContainer, [{
	        key: 'renderNumber',
	        value: function renderNumber(n, i) {
	            var isSelected = _underscore2.default.contains(this.props.chosen, n);
	            return _react2.default.createElement(_Number2.default, { key: i, number: n, isSelected: isSelected });
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            var ns = this.props.numbers;
	            return _react2.default.createElement(
	                'div',
	                null,
	...
	exports.default = NumbersContainer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Number = function (_React$Component) {
	    ...
	    function Number(props) {
	        ...
	        _this.cssClass = (0, _classNames2.default)({
	            number: true,
	    ...
	    _createClass(Number, [{
	        ...
	        value: function shouldComponentUpdate(nextProps, nextState) {
	            return this.props.isSelected !== nextProps.isSelected || this.props.number !== nextProps.number;
	        }
	    }, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _numbersReducer = __webpack_require__(190);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(183)(global || window || undefined);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _selection = __webpack_require__(192);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var selectFrom = function selectFrom(pool, numberToSelect) {
	    var result = [];
	    ...
	    while (result.length < numberToSelect) {
	        ...
	        var chosen = pool[rnd];
	        if (_underscore2.default.contains(result, chosen) === false) {
	            result.push(chosen);
	        }
	    }
